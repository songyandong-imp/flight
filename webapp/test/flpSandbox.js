		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flight",
									"targetURL": "#comsapflight-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapflight-display": {
								"semanticObject": "comsapflight",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.flight",
									"url": sap.ui.require.toUrl("com/sap/flight")
								}
							}
						}
					}
